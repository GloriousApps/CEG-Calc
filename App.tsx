...
export default function App() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#0d141a] font-display text-white flex items-center justify-center p-3 sm:p-6 select-none">
      <div className={`w-full h-[calc(100dvh-24px)] sm:h-[850px] sm:max-h-[90dvh] bg-[#171e24] rounded-[30px] shadow-2xl overflow-hidden flex ${isLandscape ? 'max-w-[1100px] flex-row' : 'max-w-[492px] flex-col'}`}>
        ...
        <section className={`${isLandscape ? 'w-[48%] h-full border-l border-[#1b3446]' : 'flex-[5.5] border-t border-[#1b3446]'} min-h-0 bg-[#151b20] px-3 pb-4 pt-2 flex flex-col`}>
          <div className="grid grid-cols-5 grid-rows-5 gap-2 w-full h-[88%] min-h-0 mt-auto">
